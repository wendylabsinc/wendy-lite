/* Re-export the shared Wendy C header for Swift interop */
#include "../../../../include/wendy.h"

/*
 * 8x16 bitmap font — printable ASCII (space 0x20 .. tilde 0x7E)
 * 95 characters, 16 bytes each, MSB = leftmost pixel.
 * Based on the classic IBM VGA / CP437 8x16 font (public domain).
 */
...
static inline unsigned char font8x16_get(int ch, int row) {
    if (ch < 32 || ch > 126) return 0;
    return font8x16_data[(ch - 32) * 16 + row];
}
