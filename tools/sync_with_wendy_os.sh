...
PAIRS=(
    ...
    "go/console/liteclient/link_ble.go:go/internal/cli/liteclient/link_ble.go"
    "go/console/liteclient/link_direct.go:go/internal/cli/liteclient/link_direct.go"
    "go/console/liteclient/link_direct_test.go:go/internal/cli/liteclient/link_direct_test.go"
    ...
    "go/internal/shared/ble/lite_info.go:go/internal/shared/ble/lite_info.go"
    "go/internal/shared/ble/central/conn.go:go/internal/shared/ble/central/conn.go"
    "go/internal/shared/ble/central/uuid.go:go/internal/shared/ble/central/uuid.go"
    "go/internal/shared/ble/central/uuid_test.go:go/internal/shared/ble/central/uuid_test.go"
    "go/internal/shared/ble/central/ble_darwin.go:go/internal/shared/ble/central/ble_darwin.go"
    "go/internal/shared/ble/central/ble_darwin.h:go/internal/shared/ble/central/ble_darwin.h"
    "go/internal/shared/ble/central/ble_darwin.m:go/internal/shared/ble/central/ble_darwin.m"
    "go/internal/shared/ble/central/live_test.go:go/internal/shared/ble/central/live_test.go"
    "go/internal/shared/ble/scan/scan.go:go/internal/shared/ble/scan/scan.go"
    "go/internal/shared/ble/scan/scan_test.go:go/internal/shared/ble/scan/scan_test.go"
    "go/internal/shared/ble/scan/uuid.go:go/internal/shared/ble/scan/uuid.go"
    "go/internal/shared/ble/scan/uuid_test.go:go/internal/shared/ble/scan/uuid_test.go"
    "go/internal/shared/ble/scan/scan_darwin.go:go/internal/shared/ble/scan/scan_darwin.go"
    "go/internal/shared/ble/scan/scan_darwin.h:go/internal/shared/ble/scan/scan_darwin.h"
    "go/internal/shared/ble/scan/scan_darwin.m:go/internal/shared/ble/scan/scan_darwin.m"
)
